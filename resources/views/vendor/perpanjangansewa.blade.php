        ...
        <div class="overflow-x-auto">
            @if (empty($extens) || count($extens) == 0)
                <div class="flex flex-col items-center justify-center text-center p-10 bg-white rounded-lg shadow-md">
                    <i class="fas fa-clock fa-3x text-gray-400 mb-4"></i>
                    <h2 class="text-2xl font-semibold text-gray-700">Belum Ada Permintaan Perpanjangan</h2>
                    <p class="text-gray-600 mt-2">Tidak ada permintaan perpanjangan sewa untuk ditampilkan.</p>
                </div>
            @else
                                ...
                                <div
                                    ...
                                    <div class="flex flex-col md:flex-row gap-6">
                                        ...
                                        <div class="w-full md:w-1/2 space-y-3 text-sm sm:text-base text-gray-700">
                                            <p><span class="font-semibold">Nama:</span> {{ $extension['customer_name'] }}
                                            </p>
